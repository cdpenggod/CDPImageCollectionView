...
@interface VerticalViewController () <CDPImageCollectionViewDelegate>//代理
@end
...
- (void)viewDidLoad {
    ...
    //imageCollectionView为竖向滚动
    CDPImageCollectionView *imageCollectionView=[[CDPImageCollectionView alloc] initWithFrame:CGRectMake(80,60,100,200) andImageUrlArr:imageArr scrollDirection:UICollectionViewScrollDirectionVertical];
